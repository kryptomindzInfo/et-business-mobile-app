...
class GetCardScreen extends ConsumerWidget {
  ...
  final GetCardScreenArgs params;
  const GetCardScreen({super.key, required this.params});
              ...
              children: [
                ...
                CommonWhiteFlexibleCard(
                  ...
                  widget: Column(
                    children: [
                      Image.asset(
                        proWatch.getCardsScreenData[
                            proWatch.getCardsScreenIndex]["data"]["icon"],
                        height: 35,
                      ),
                      5.spaceY,
                      Text(
                        proWatch.getCardsScreenData[
                            proWatch.getCardsScreenIndex]["title"],
