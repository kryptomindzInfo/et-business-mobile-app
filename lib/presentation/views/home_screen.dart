...
//         IconButton(
//             onPressed: () => ref.read(localizationProvider).setLanguage(
//                 ref.read(localizationProvider).languageIndex == 0 ? 1 : 0),
...
// //                   .setLanguage(ref.watch(localizationProvider).languageIndex == 0 ? 1 : 0),
// //               icon: const Icon(Icons.language)),
// //         //   IconButton(
// //         //       onPressed: () async {
// //         //         // http://www.africau.edu/images/default/sample.pdf
